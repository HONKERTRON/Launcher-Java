...
public class Settings
{
	...
	public static final String  domain	 	         = "whitebite.su";//Домен сайта
	public static final String  siteDir		         = "Launcher/site";//Папка с файлами лаунчера на сайте
	public static final String RegisterUrl	         = http+"whitebite.sy/";//Ссылка на регистрацию, при useRegister = false
	public static final String  updateFile		     = http+"localhost/Launcher/site/launcher/fix";//Ссылка на обновления лаунчера. Не писать на конце ".exe .jar"!
	...
	public static int height                         = 644;      //Высота окна клиента
	public static int width                          = 1024;      //Ширина окна клиента
